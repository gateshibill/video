...
function numberFormat(number){
    ...
    if (number>=b && number<c){
        return (number/b).toFixed(2) + '千';
    }else if (number>=c && number<d){
        return (number/c).toFixed(2) + '万';
    }else {
        return (number/d).toFixed(2) + '亿';
    }
}
...
function refreshTimeLine(){
    ...
    $.ajax({
        ...
        success:function(a){
            ...
            $('#guName').html(dayData[1]);
            $('#jiage').html(dayData[3]);
            $('#zuoshou').html(dayData[4]);
            $('#jinkai').html(dayData[5]);
            $('#zuigao').html(dayData[33]);
            $('#zuidi').html(dayData[34]);

            $('#zhenfu').html(dayData[43] + "%");
            $('#chengjiaoliang').html(numberFormat(dayData[36]) + "手");
            $('#chengjiaoe').html(dayData[37] + "万");
            $('#neipan').html(numberFormat(dayData[8]) + "手");
            $('#waipan').html(numberFormat(dayData[7]) + "手");
            $('#zongshizhi').html(dayData[45] + "亿");
            $('#shiyinglv').html(dayData[39]);
            $('#liutongshizhi').html(dayData[44] + "亿");
        }
    });
}
$(function(){
