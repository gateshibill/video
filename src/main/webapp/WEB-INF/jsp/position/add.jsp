		    ...
		    <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number" style="width: 400px;"
						...
						class="layui-input" lay-verify="appId">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style="width: 400px;"
						...
						class="layui-input" lay-verify="positionName">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style=" width: 400px;"
						...
						class="layui-input" lay-verify="experience">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style=" width: 400px;"
						...
						class="layui-input" lay-verify="education">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style=" width: 400px;"
						...
						class="layui-input" lay-verify="hrPhone">
				</div>
			</div>
		   <div class="layui-form-item">
...
layui.use([ 'form', 'layer','layedit'],
	 ...
	 form = layui.form, layer = layui.layer,layedit = layui.layedit;
		...
		form.on('submit(demo1)', function(data) {
			...
			$.ajax({
				type : "post",
				url : "${ctx}/position/doAddPosition.do",
				dataType:"json",
				data : {
