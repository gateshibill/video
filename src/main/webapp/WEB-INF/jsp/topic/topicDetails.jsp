...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>文章【${common.topicName}】的详情</legend>
		</fieldset>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value">${common.topicId}</label>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value"> <input type="text"
					...
					name="topicName" value="${common.topicName}"
					lay-verify="topicName" autocomplete="off" class="layui-input" /></label>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<c:choose>
					<c:when test="${common.topicStatus==1}">
		...
		<div class="layui-form-item">
			...
			<%-- <div class="layui-input-block">
				...
				<textarea class="layui-textarea layui-hide" name="content"
					lay-verify="content" id="goodsDetails_edit">${common.topicContent}</textarea>
			</div> --%>
			<div class="layui-input-block">
...
//封面回显
var collCoverArr="${common.topicPic}".split(",");
					...
					function() {
						...
						form.on('submit(demo1)',function(data) {
							...
							var images_collCover = upload_collCover.substr(1,upload_collCover.length-1);
											$.ajax({
														type : "post",
														url : '${ctx}/topic/updateTopic.do',
														// 								url : "${ctx}/goods/updateGoods.do",
														dataType : "json",
														data : {
															"topicId" : '${common.topicId}',
															"topicStatus" : data.field.status,
															"topicName" : data.field.topicName,
															"topicPic":images_collCover,
