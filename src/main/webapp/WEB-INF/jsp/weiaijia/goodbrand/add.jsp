		...
		<div class="layui-form">	  
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style="width: 400px;"
						name="cnBrandName"  autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number" style=" width:400px;"
						name="brandOrder"  autocomplete="off"
						class="layui-input">
				</div>
			</div>
		 ...
		 <div class="layui-form-item">        
	           <div class="layui-upload">
	                  ...
	                  <div class="layui-upload-list" id="logolist" style="cursor: pointer;padding-left:100px"></div>
	          </div>
          </div>
...
layui.use([ 'form', 'layer'],
	 ...
	 form = layui.form, layer = layui.layer;
		...
		form.on('submit(demo1)', function(data) {
			...
			$.ajax({
				type : "post",
				url : "${ctx}/goodbrand/doAddGoodBrand.do",
				dataType:"json",
				data : {
