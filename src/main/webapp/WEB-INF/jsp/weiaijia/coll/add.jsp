	...
	<div style="margin: 15px;">
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="collTitle"  autocomplete="off" class="layui-input" lay-verify="collTitle">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">描述：</label>
				<div class="layui-input-block">
					<input type="text" name="collDesc"  autocomplete="off" lay-verify="collTitle" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入介绍" name="collDetail" class="layui-textarea" lay-verify="collDetail"></textarea>
				</div>
			</div>
