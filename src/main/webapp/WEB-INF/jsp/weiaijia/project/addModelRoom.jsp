		...
		<div class="layui-form">
			<div class="layui-form-item">
				<label class="layui-form-label">板间标题:</label>
					<div class="layui-input-block">
						<input type="text" name="modelTitle" autocomplete="off" class="layui-input" lay-verify="modelTitle" maxlength="255" placeholder="请输入标题">
					</div>
			</div>
			...
			<div class="layui-form-item" style="margin-top:15px;">
				<label class="layui-form-label">排序:</label>
					<div class="layui-input-block">
						<input type="number" name="orderStatus" autocomplete="off" class="layui-input" lay-verify="orderStatus" placeholder="请输入排序">
					</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">描述：</label>
				<div class="layui-input-block">
					<textarea placeholder="请输入施工描述" id="modelDesc" lay-verify="modelDesc" class="layui-textarea" name="modelDesc" maxlength="450"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
	...
	var form = layui.form, layer = layui.layer;
		...
		form.on('submit(demo1)', function(data) {
			...
			if(designArr.length < 1){
				...
				$.ajax({
					type : "post",
					url : "${ctx}/newProject/addModelRoom.do",
					dataType:"json",
					data : { 
