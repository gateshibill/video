	...
	<form class="layui-form" method="post" action="" id="listform">
		<blockquote class="layui-elem-quote news_search">
			<div class="layui-inline">
				...
				<button class="layui-btn layui-btn-normal " id="" onclick="demo1()">施工确定</button>
			</div>
		</blockquote>
	</form>
					...
					$(".newsAdd_btn").click(function() {
								var index = layui.layer
										.open({
											title : "添加小类施工计划",
											type : 2,
											content : "${ctx}/newProject/goAddWorkPlan.do?projectId="+"${projectWorkPlan.projectId}"
													+"&planTypeId="+"${projectWorkPlan.planTypeId}",
											success : function(
													layero,
													index) {
						...
						$(".newsJin_btn").click(function() {
								var index = layui.layer
										.open({
											title : "查看施工进度",
											type : 2,
											content : "${ctx}/newProject/goWorkJindu.do?projectId="+"${projectWorkPlan.projectId}",
											success : function(
													layero,
													index) {
												setTimeout(
			...
			if (obj.event === 'projectWorkBigPlay') {
				var index = layui.layer
						.open({
							title : "验收不通过原因",
							type : 2,
							content : "${ctx}/newProject/goProjectWorkPlay.do?planId="
									+ data.planId,
