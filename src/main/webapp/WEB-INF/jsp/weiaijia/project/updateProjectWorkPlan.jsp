		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block" style="width:400px;margin-left:130px">
					<select name="bigPlanName" lay-verify="bigPlanName" lay-search="">
					<c:forEach var="t" items="${tList}">
						<c:if test="${projectWorkBigPlan.bigPlanName == t.typeName}">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block" style="width:400px;margin-left:130px">
					<select name="isCheck" style="width:400px">
						<option value="1" <c:if test="${projectWorkBigPlan.isCheck==1}"> selected="selected"</c:if>>是</option>
						<option value="0" <c:if test="${projectWorkBigPlan.isCheck==0}"> selected="selected"</c:if>>否</option>					
					</select>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block" style="width:400px;margin-left:130px">
					<input type="number" name="orderStatus"  autocomplete="off" class="layui-input" lay-verify="orderStatus" value="${projectWorkBigPlan.orderStatus}">
				</div>
			</div>
			<div class="layui-form-item">
			      <label class="layui-form-label">计划开始时间：</label>
			      <div class="layui-input-block" style="width:400px;margin-left:130px">
			        <input name="planStartTime" type="text" class="layui-input" id="test1" placeholder="请选择计划开始时间" lay-verify="planStartTime" value="${projectWorkBigPlan.bigPlanStartTimeS}">
			      </div>
			</div>
			<div class="layui-form-item">
			      <label class="layui-form-label">计划结束时间：</label>
			      <div class="layui-input-block" style="width:400px;margin-left:130px">
			        <input name="planEndTime" type="text" class="layui-input" id="test2" placeholder="请选择计划结束时间" lay-verify="planStartTime" value="${projectWorkBigPlan.bigPlanEndTimeS}">
			      </div>
			</div>
			<div class="layui-form-item">
			      <label class="layui-form-label">真实开始时间：</label>
			      <div class="layui-input-block" style="width:400px;margin-left:130px">
			        <input name="realStartTime" type="text" class="layui-input" id="test3" placeholder="请选择真实开始时间" lay-verify="realStartTime" value="${projectWorkBigPlan.bigRealStartTimeS}">
			      </div>
			</div>
			<div class="layui-form-item">
			      <label class="layui-form-label">真实结束时间：</label>
			      <div class="layui-input-block" style="width:400px;margin-left:130px">
			        <input name="realEndTime" type="text" class="layui-input" id="test4" placeholder="请选择真实结束时间" lay-verify="realStartTime" value="${projectWorkBigPlan.bigRealEndTimeS}">
			      </div>
			</div>
			<div class="layui-form-item">
...
layui.use([ 'form', 'layer'],
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/newProject/updateWorkBigPlan.do",
				dataType:"json", 
				data : {
					"bigPlanEndTimeS":data.field.planEndTime,
					"bigPlanStartTimeS":data.field.planStartTime,
					"bigRealEndTimeS":data.field.realEndTime,
					"bigRealStartTimeS":data.field.realStartTime, 
