		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="realName"  value="${adviser.realName}" autocomplete="off" class="layui-input" lay-verify="required">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">联系方式：</label>
				<div class="layui-input-block">
					<input type="text" name="phone"  value="${adviser.phone}" autocomplete="off" lay-verify="required" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">电子邮箱：</label>
				<div class="layui-input-block">
					<input type="text" name="email"  value="${adviser.email}" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block" >
					<input type="text" name="position" value="${adviser.position}" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="city" lay-verify="required"  value="${adviser.city}" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<ul class="layer-photos-demo" id="Images">
					<li><img src="${adviser.images}"/>	</li>
				</ul>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">介绍：</label>
				<div class="layui-input-block">
					<textarea placeholder="请输入介绍" name="introduce" class="layui-textarea">${adviser.introduce}</textarea>
				</div>
			</div>
...
layui.use([ 'form', 'layer'],
	 ...
	 form = layui.form(), layer = layui.layer;
		...
		form.on('submit(demo1)', function(data) {
			...
			$.ajax({
				type : "post",
				url : "${ctx}/factory/doupdateFactory.do",
				dataType:"json",
				data : {
