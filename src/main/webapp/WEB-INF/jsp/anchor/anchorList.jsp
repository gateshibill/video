		...
		<form class="layui-form layui-form-pane" action="">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label">主播状态</label>
					<div class="layui-input-block">
	...
	layui.use([ 'layer', 'table', 'laydate' ], function() {
		...
		function getlist(pid, lp2, ism, id, name,type,groupId,status,rank,isAgent) {
			tableIns = table.render({
				...
				url : '${ctx}/anchor/getAnchorList.do',
				cols : [ [ 
// 				  {
// 					checkbox : true,
// 					LAY_CHECKED : false,
		...
		table.on('tool(descovery)', function(obj) {
			...
			if (obj.event === 'lookUser') {
				...
				.open({
					title : "编辑",
					type : 2,
					content : "${ctx}/anchor/getAnchorById.do?id="+data.id,
					success : function(
							layero,
							index) {
						setTimeout(
				...
				if(data.status==1){
					$.ajax({
						data : 'json',
						url : '${ctx}/anchor/updateAnchor.do',
						type : "post",
						data : {
							id : data.id,
							status:2
