	...
	<div style="margin: 15px;">
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" style="display: inline !important; width: 210px;"
						name="price" id="price" value="${pinGoods.price}" lay-verify="job" autocomplete="off"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" style="display: inline !important; width: 210px;"
						name="validate" id="validate" value="${pinGoods.validate}" lay-verify="job" autocomplete="off"
...
<script type="text/javascript">
	...
	layui.use([ 'form', 'layer', 'laydate' ], function() {
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/wx/activity/updatePinGoodsById.do",
				dataType : "text",
				data : {
					"id" : "${pinGoods.id}",
					"goodsId" : "${pinGoods.goodsId}",
					"price" : $("#price").val(),
