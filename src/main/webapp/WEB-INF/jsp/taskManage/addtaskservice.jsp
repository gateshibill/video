...
<body class="childrenBody">
		...
		<div class="layui-form-item">	
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input type="text" id="content" class="layui-input newsAuthor" lay-verify="required" placeholder="请输入服务内容">
				</div>
			</div>				
		</div>
    ...
    <div class="layui-input-block" style="width:200px;" id="select-input">
      <select name="type" id="type" lay-verify="required" style="width:200px;">
...
layui.use('layer',function(){
    ...
    $("#send").on('click',function(){
      ...
      if(!content){
    	...
    	$.ajax({
    		 url:'${ctx}/sharetask/doaddtaskservice.do',
    		 type:'post',
    		 dataType:'json',
    		 data:{'service':content,'type':type},
