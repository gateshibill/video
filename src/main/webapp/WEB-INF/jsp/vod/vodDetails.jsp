...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>【${channel.name}】频道详情</legend>
		</fieldset>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value">${channel.id}</label>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value"> <input type="text"
					style="display: inline !important; width: 200px;"
					name="groupId" value="${channel.groupId}"
					lay-verify="name" autocomplete="off" class="layui-input" /></label>
			</div>
		</div>	
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value"> <input type="text"
					...
					name="playUrl" value="${channel.playUrl}"
					lay-verify="name" autocomplete="off" class="layui-input" /></label>
			</div>
		</div>	
		<div class="layui-form-item">
			<label class="layui-form-label">播放备用串：</label>
			<div class="layui-input-block">
				<label class="detail-label-value"> <input type="text"
					style="display: inline !important; width: 500px;"
					name="reserveUrls" value="${channel.reserveUrls}"
					lay-verify="name" autocomplete="off" class="layui-input" /></label>
			</div>
		</div>			
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<label class="detail-label-value"> <input type="text"
					style="display: inline !important; width: 500px;"
					name="posterUrl" value="${channel.posterUrl}"
					lay-verify="name" autocomplete="off" class="layui-input" /></label>
			</div>
		</div>
			<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<%-- <div class="layui-input-block">
				...
				<textarea class="layui-textarea layui-hide" name="content"
					lay-verify="content" id="goodsDetails_edit">${channel.content}</textarea>
			</div> --%>
			<div class="layui-input-block">
...
//封面回显
var collCoverArr="${channel.posterUrl}".split(",");
					...
					function() {
						...
						form.on('submit(demo1)',function(data) {
							...
							var images_collCover = upload_collCover.substr(1,upload_collCover.length-1);
											$.ajax({
														type : "post",
														url : '${ctx}/channel/updateChannel.do',
														...
														data : {
															...
															"rcmd" : data.field.rcmd,
															"playUrl" : data.field.playUrl,
															"reserveUrls" : data.field.reserveUrls,
