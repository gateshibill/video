...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>频道【${currUser.name}】的详情</legend>
		</fieldset>
		<div class="layui-form-item">
			<label class="layui-form-label">频道编号：</label>
			<div class="layui-input-block">
				<label class="layui-form-label">${currUser.id}</label>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">频道名称：</label>
			<div class="layui-input-block">
				<label class="detail-form-label">${currUser.name}</label>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">频道类型：</label>
			<div class="layui-input-inline">
				<label class="layui-form-label">${currUser.type}</label>
			</div>
		</div>
		
		<div class="layui-form-item">
			<label class="layui-form-label">频道海报：</label>
			<div class="layui-input-inline">
				<label class="layui-form-label"><img
					src="${currUser.posterUrl}"
					style="width: 400px; height: 200px;" /></label>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">频道排序：</label>
				<div class="layui-input-inline">
					<label class="layui-form-label">${currUser.rank}</label>
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">频道播放串：</label>
			<div class="layui-input-block">
				<label class="layui-form-label">${currUser.playUrl}</label>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">频道备用播放串：</label>
			<div class="layui-input-block">
				<label class="layui-form-label">${currUser.reserveUrls}</label>
			</div>
		</div>		
<%--		
		<div class="layui-form-item">
