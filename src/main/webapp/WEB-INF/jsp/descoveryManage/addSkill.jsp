...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>发布技能到【${common.applicationName}】应用</legend>
		</fieldset>
		...
		<input type="hidden" name="descoveryType" value="${descoveryType}" >
			<div class="layui-form-item">
					...
					<div class="layui-input-inline" style="width: 210px;">
						<select name="skillType" lay-verify="skillType" autocomplete="off"
						class="layui-input">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text"
						style="display: inline !important; width: 200px;"
						name="servicePrice" lay-verify="firstCost" autocomplete="off"
						class="layui-input" value=""><span>元</span>
				</div>
			</div>
					<div class="layui-form-item">
				<label class="layui-form-label">附带服务：</label>
							...
							var needResourceTag = needtags.join(",");
											...
											$.ajax({
														...
														data : {
															...
															"skillType": data.field.skillType,
															"descoveryImage":descoveryImage.src,
															"photosBook":photosBook.src,
															"bidWay":data.field.bidWay,
															"explanatoryService":hasResourceTag,
															"serviceWay":hasResourceTag,
															"servicePrice":data.field.servicePrice,
