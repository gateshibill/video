...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>项目【${common.descoveryTitle}】的详情</legend>
		</fieldset>
		<div class="layui-form">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">项目相册：</label>
				<div class="layui-input-block">
					<label class="detail-label-value"><img src="${common.photosBook}"/></label>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">拥有资源：</label>
				<div class="layui-input-block">
					<label class="detail-label-value">
					<c:forEach items="${projectTags}" var="tags">
							<c:if test="${tags.childtagOrder==1}">
								<c:choose>
									<c:when
										test="${fn:contains(common.getHasResourceTag(),tags.getChildtagId())}">
										<input type="checkbox" name="inquiryTags"
											id="inquiryTags" value="${tags.getChildtagId()}"
											lay-verify="inquiryTags" title="${tags.getChildtagName()}"
											checked="checked">
									</c:when>
									<c:otherwise>
										<input type="checkbox" name="inquiryTags"
