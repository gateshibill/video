...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>资源【${common.descoveryTitle}】的详情</legend>
		</fieldset>
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<c:choose>
						<c:when test="${common.freePost==1}">
							<label class="detail-label-value">是</label>
						</c:when>
						<c:otherwise>
							<label class="detail-label-value">否</label>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<label class="detail-label-value">${common.productPrice}元
					</label>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">竞标方式：</label>
				<div class="layui-input-block">
					<label class="detail-label-value">
						${common.bidWay}
					</label>
