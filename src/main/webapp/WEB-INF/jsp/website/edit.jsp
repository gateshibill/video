	...
	<div style="margin: 15px;">
		<div class="layui-form">	  
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style="width: 400px;"
						name="cname" value="${web.cname}" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" >
					<input type="text" style="width: 400px;"
						name="cphone" value="${web.cphone}" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" style=" width: 400px;"
						name="caddress" value="${web.caddress}" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			 ...
			 <div class="layui-form-item">        
	           <div class="layui-upload">
	                  ...
	                  <div class="layui-upload-list" id="logolist" style="cursor: pointer;">
	                  		<img src="${web.logo}" />
	                  </div>
	          </div>
          </div>
		<!-- 
			<div class="layui-form-item">
			   <div class="layui-upload">
	                  <label class="layui-form-label" style="width: 100px;">官网轮播图：</label>
	                     ...
	                     <span style="color:red">上传图片之后点击图片即可删除图片</span>
	                  <div class="layui-upload-list" id="bannerlist" style="cursor: pointer;">
          ...
          <div class="layui-form-item">        
	           <div class="layui-upload">
	                  <label class="layui-form-label" style="width: 100px;">公司介绍：</label>
	                     ...
	                     <span style="color:red">上传图片之后点击图片即可删除图片</span>
	                  <div class="layui-upload-list" id="cintrolist" style="cursor: pointer;">
	                  		<img src="${web.cintro}" />
	                  </div>
	          </div>
          </div>
          ...
          <div class="layui-form-item">        
           <div class="layui-upload">
                  <label class="layui-form-label" style="width: 100px;">团队成员：</label>
                     ...
                     <span style="color:red">上传图片之后点击图片即可删除图片</span>
                  <div class="layui-upload-list" id="teamlist" style="cursor: pointer;">
                  	 <img src="${web.team}" />
                  </div>
          </div>
          </div>
          <div class="layui-form-item">    
           <div class="layui-upload">
                  <label class="layui-form-label" style="width: 100px;">人才需求：</label>
                     ...
                     <span style="color:red">上传图片之后点击图片即可删除图片</span>
                  <div class="layui-upload-list" id="cfindlist" style="cursor: pointer;">
                  	  <img src="${web.cfind}" />
                  </div>
          </div>
          </div>
          <div class="layui-form-item">     
           <div class="layui-upload">
                  <label class="layui-form-label" style="width: 100px;">客户案例：</label>
                     ...
                     <span style="color:red">上传图片之后点击图片即可删除图片</span>
                  <div class="layui-upload-list" id="kehulist" style="cursor: pointer;">
                  	<img src="${web.kehu}" />	
                  </div>
          </div>
          </div>
          <div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
				<input type="hidden" value="${web.id}" name="id"/>
