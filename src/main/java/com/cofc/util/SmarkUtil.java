...
public class SmarkUtil {
	 ...
	 * @throws Exception
	 */
	public void addChatMessageListener(ChatMessageListener chatMessageListener) throws Exception {
		ChatManager chatManager = ChatManager.getInstanceFor(connection);
	...
	public static void main(String[] args) throws Exception {
		// String userName, String password, String xmppDomain, String serverName
		SmarkUtil smackClient = new SmarkUtil("yinlibao", "123456", "desktop-4q8bd96", "192.168.10.83");
		smackClient.addChatMessageListener(new ChatMessageListener() {
			@Override
			public void processMessage(Chat chat, Message message) {
				...
				try {
					smackClient.sendMessage(from, "你好！");
				} catch (Exception e) {
